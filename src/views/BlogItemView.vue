<script setup>
	...
	import TestimonialPanel from '../components/TestimonialPanel.vue';
			...
			<div class="container-fluid">
				...
				<section class="blog-post-section section has-profile-image mx-auto">
					...
					<div class="blog-entry">                 
						<article class="post">
							<h2 class="post-title text-center py-2">Blog Post Heading Lorem Ipsum</h2>
							
							<div class="post-author text-center mb-3">By <a href="index-2.html">Daniel Lopez</a></div>
							
							<div class="post-meta"> 
								<ul class="meta-list list-inline d-flex justify-content-center">                                       
									<li class="list-inline-item post-time">Apr 19</li>
									<li class="list-inline-item post-length">8 min read</li>
							...
							<div class="post-content">
								<p class="post-figure">
									<img class="img-fluid rounded" src="@/assets/images/blog/blog-post-banner.jpg" alt="image">
								</p><!--//post-figure-->
								...
								<figure class="blog-quote-holder p-4 p-lg-5 my-5 rounded">
									<blockquote class="blockquote theme-custom-quote">
										<p><i class="quote-icon fa-solid fa-quote-left d-none d-lg-inline-block"></i>You don't have to be great to start, but you have to start to be great.</p>
									</blockquote>   
									<figcaption class="blockquote-footer">
										<cite title="Source Title">Zig Ziglar</cite>
									</figcaption>
								</figure><!--//blog-quote-holder-->
		
								<p>Cras adipiscing ipsum vel molestie cursus. In ultrices tristique vestibulum. Aenean ut dui diam. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Ut bibendum ipsum nec sagittis ultrices. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Vivamus id ante diam. Pellentesque mauris lacus, dictum sodales elit quis, pulvinar tempus leo. <a class="post-content-link" href="#">This is a link</a> pellentesque sed leo dignissim, ornare nunc vitae, volutpat quam. Nam pellentesque tortor eu nibh porttitor congue. Sed at porta lectus.</p>
								
								
								
								
								<ul class="post-list ps-5 py-3">
									<li>Lorem <strong class="text-highlight">90% increase</strong> dolor sit amet consectetuer.</li>
									<li>Aenean commodo <strong class="text-highlight">$1200</strong> ligula eget dolor.</li>
									<li>Aenean massa <strong class="text-highlight">2M views</strong> cum sociis natoque penatibus.</li>
									
									<li>Aenean ut <strong class="text-highlight">30K downloads</strong> dui diam.</li>
								</ul>
...
... prompt'''
								...
								<h3 class="post-content-heading">Blog Post Section Heading Lorem</h3>
								...
								<p>Morbi vulputate bibendum fringilla. Sed fermentum nisi laoreet, porttitor ipsum et, vehicula diam. Fusce iaculis turpis dolor, et cursus arcu cursus vel. Ut lobortis tellus ornare ultrices tristique. Praesent cursus, mi ac rutrum ultrices, lectus erat pellentesque urna, at placerat eros nisi vitae ligula. Fusce eget lacus non ipsum vestibulum consequat. Nulla eleifend magna et urna vulputate, vitae volutpat magna varius. </p>
								
								<ul class="post-list list-unstyled ps-4 py-3">
								   <li><i class="bi bi-check me-2"></i>Lorem ipsum dolor sit amet, consectetuer adipiscing elit.</li>
								   <li><i class="bi bi-check me-2"></i>Aliquam tincidunt mauris eu risus.</li>
								   <li><i class="bi bi-check me-2"></i>Vestibulum auctor dapibus neque.</li>
								   <li><i class="bi bi-check me-2"></i>Sagittis tempus lacus enim ac dui.</li>
								</ul>
								...
								<h3 class="post-content-heading">Blog Post Section Heading Lorem Ipsum</h3>
							...
							<nav class="post-nav d-flex justify-content-between mb-5">
									<div class="nav-previous"><a href="#" rel="prev"><i class="bi bi-arrow-left me-2"></i>Previous</a></div>
									<div class="nav-next"><a href="#" rel="next">Next<i class="bi bi-arrow-right ms-2"></i></a></div>
							</nav><!--//post-nav-->
							
							<div id="blog-comment-area" class="blog-comment-area">
								<div class="comment-container">        				    
									<div class="comment-list">
										<h3 class="title">6 Comments</h3>
										<div class="comment-item depth-1 parent">
											<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
												<div class="comment-author col-auto me-2">
													<img class="img-fluid" src="@/assets/images/blog/user-4.jpg" alt="" />
												</div><!--//comment-author-->
												<div class="comment-body col">
													<cite class="name">Sarah Doe Says:</cite>
													<p class="time">Apr 23 at 3:16pm</p>
													<div class="content">
														<p>You can click the reply button of this comment to see an example of the reply form. 👇😊 </p>
													</div><!--//content-->
													<a class="comment-reply-link btn btn-secondary" href="#respond-1" data-bs-toggle="collapse" role="button" aria-expanded="false">Reply</a>
													<div id="respond-1"  class="collapse">
														<div class="comment-reply-holder p-0 p-lg-5 my-3 rounded" >
															<h4 id="reply-title" class="reply-title mb-3" aria-level="1">Reply to Sarah Doe</h4>
															<form id="reply-form" class="reply-form form" method="post" action="#">                   
																<div class="row g-3">  
																	<div class="col-12 ">
																		<label class="sr-only" for="ccomment">Leave a Comment</label>
																		<textarea class="form-control" id="reply-comment" name="reply-comment" placeholder="Leave your reply" rows="12" required></textarea>
																	</div>                                                                                                                                                                   
																	<div class="col-md-6 col-12">
																		<label class="sr-only" for="rname">Name</label>
																		<input type="text" class="form-control" id="rname" name="name" placeholder="Name" minlength="2" required>
																	</div>                    
																	<div class="col-md-6 col-12 ">
																		<label class="sr-only" for="remail">Email</label>
																		<input type="email" class="form-control" id="remail" name="email" placeholder="Email" required>
																	</div>								                                    
																	<div class="col-12 ">
											...
											<div class="children">
												<div class="comment-item depth-2 child">
													<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
														<div class="comment-author col-auto me-2">
															 <img class="img-fluid" src="@/assets/images/blog/user-2.jpg" alt="" />
														</div><!--//comment-author-->
														<div class="comment-body col">
															<cite class="name">Sam Oliver Says:</cite>
															<p class="time">Apr 23 at 4:23pm</p>
															<div class="content">
																<p>Proin ut condimentum ante. Donec in urna dapibus massa sodales varius et eu eros. Integer ac turpis sed dui pulvinar consectetur. Interdum et malesuada fames ac ante ipsum primis in faucibus. Sed pellentesque eu lorem sit amet elementum. Cras et mauris ac turpis maximus tempor vitae a lectus. </p>
															</div><!--//content-->
															<a class="comment-reply-link btn btn-secondary" href="#">Reply</a>
														</div><!--//comment-body-->          
													</div><!--//comment-box--> 
													<div class="children">
														<div class="comment-item depth-3 child">
															<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
																...
																<div class="comment-body col">
																	<cite class="name">Sarah DoeSays:</cite>
																	<p class="time">Apr 23 at 8:16pm</p>
																	<div class="content">
										...
										<div class="comment-item depth-1 parent">
											<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
												<div class="comment-author col-auto me-2">
													<img class="img-fluid" src="@/assets/images/blog/user-1.jpg" alt="" />
												</div><!--//comment-author-->
												<div class="comment-body col">
													<cite class="name">Tom Wang Says:</cite>
													<p class="time">May 08 at 13:10pm</p>
													<div class="content">
										...
										<div class="comment-item depth-1 parent">
											<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
												<div class="comment-author col-auto me-2">
													<img class="img-fluid" src="@/assets/images/blog/user-0.jpg" alt="" />
												</div><!--//comment-author-->
												<div class="comment-body col">
													<cite class="name">Anonymous Says:</cite>
													<p class="time">May 09 at 13:12pm</p>
													<div class="content">
														<p>Sed condimentum?</p>
													</div><!--//content-->
													<a class="comment-reply-link btn btn-secondary" href="#">Reply</a>
										...
										<div class="comment-item depth-1 parent">
											<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
												<div class="comment-author col-auto me-2">
													<img class="img-fluid" src="@/assets/images/blog/user-3.jpg" alt="" />
												</div><!--//comment-author-->
												<div class="comment-body col">
													<cite class="name">Dave Morgan Says:</cite>
													<p class="time">May 12 at 9:35am</p>
													<div class="content">
											...
											<div class="children">
												<div class="comment-item depth-2 child">
													<div class="comment-item-box d-flex p-0 p-lg-4 mb-5 rounded">
														...
														<div class="comment-body col">
															<cite class="name">Sam Oliver Says:</cite>
															<p class="time">May 12 at 4:23pm</p>
															<div class="content">
																<p>Thanks!</p>
															</div><!--//content-->
															<a class="comment-reply-link btn btn-secondary" href="#">Reply</a>
								...
								<div class="comment-form-holder">
									<h4 class="title mb-3">Leave a comment</h4>
